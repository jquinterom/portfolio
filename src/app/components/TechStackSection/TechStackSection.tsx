...
const techStack: TechStackSectionProps = {
    frontend: [
        ...
        { name: 'React Testing Library', icon: SiTestinglibrary, color: 'text-red-400' },
    ],
    android: [
        { name: 'Kotlin', icon: SiKotlin, color: 'text-orange-500' },
        { name: 'Java', icon: RiJavaFill, color: 'text-orange-500' },
        { name: 'Jetpack Compose', icon: SiJetpackcompose, color: 'text-green-500' },
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-4 md:grid-cols-10 gap-4">
                            {techStack.frontend.map((tech) => (
                                <TechIcon key={tech.name} name={tech.name} icon={tech.icon} color={tech.color} />
                            ))}
                        </div>
                    </div>
                    <div>
